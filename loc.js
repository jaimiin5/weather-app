let showTemp = () => {
    ...
    function updateWeatherUI(data) {
        ...
        const cityNotFoundDiv = document.getElementById("cityNotFound");
        cityNotFoundDiv.classList.add("hidden");
        
        const eee = document.getElementById("cityFound");
    ...
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        fetch(apiUrl)
            ...
            .then(data => {
                ...
                if (data.cod !== 200) {
                    const cityNotFoundDiv = document.getElementById("cityFound");
                    cityNotFoundDiv.classList.add("hidden");
                    const ddd = document.getElementById("cityNotFound");
